  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your {category ? category.toLowerCase() : ''} feedback reached us and
          it&apos;s already on the desk. Every report is read by a human — the
          ones that sharpen the scanner or the terminal get actioned first.
        </Text>
        {message ? (
          <Section style={quote}>
        ...
        <Text style={text}>
          No action is needed from you. If we need more detail, we&apos;ll reply
          to this address.
        </Text>
        <Hr style={hr} />
        <Text style={footer}>
          Sent because you submitted feedback inside P-Trades Hub.
        </Text>
      </Container>
    </Body>
  </Html>
