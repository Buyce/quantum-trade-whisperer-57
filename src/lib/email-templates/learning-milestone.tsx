...
const LearningMilestoneEmail = ({
  ...
  const headline = isFill
    ? 'Fill-rate gate cleared'
    : 'Win-rate gate cleared'
    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            These statistics remain observational: grading, alerting and the daily
            setup limit do not read them. Clearing a gate only changes how the
            numbers are labelled in the app. Sent once per threshold.
          </Text>
        </Container>
      </Body>
    </Html>
