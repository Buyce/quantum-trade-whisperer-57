  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          You marked these setups as taken and recorded a result, but not the prices you actually
          got. Without your real entry and exit price the R multiple cannot be calculated, so those
          wins and losses have execution prices missing.
        </Text>
        <Text style={text}>
          Add both prices in the Trade History tab and the terminal recomputes the R from the
          setup&apos;s own risk distance — a self-reported but auditable number that makes your
          price-backed win rate meaningful.
        </Text>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Prices are always optional — nothing in your history is deleted or changed if you skip
          this. You receive this reminder at most once a week, and only while trades are still
          missing prices.
        </Text>
      </Container>
    </Body>
