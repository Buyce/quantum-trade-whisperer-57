...
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ChatGPT     | On ChatGPT web, enable Developer mode in Settings → Security and login; open ChatGPT Plugins, use the plus button to create a developer-mode app, paste the MCP URL, choose OAuth, review the tools, and select the app from Developer mode in a chat                                                                             | Re-verified 2026-08-23 against OpenAI's developer guide. Full MCP client support for read and write tools is currently documented for Pro, Plus, Business, Enterprise and Education accounts on the web. P-Trades names its write tools and tells users to inspect their JSON; write actions require confirmation by default. Managed-workspace policy may still restrict access. |
